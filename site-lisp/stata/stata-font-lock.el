;;; stata-font-lock.el -- list of keywords in stata mode -*- lexical-binding: t; -*-
...
;; now use ess's font-lock
(defun ado-set-font-lock-keywords ()
  "Create font lock keywords for Stata syntax.  This is from the ado-mode of Bill Rising <brising@jhsph.edu>, and use make-regexp."
  (interactive)
  (list
...
(defvar stata-mode-font-lock-keywords (ado-set-font-lock-keywords)
  "Set the Stata mode font-lock keywords to Bill Rising's ado-mode keywords.")


(provide 'stata-font-lock)
;;; stata-font-lock.el ends here
