;;; bc-gentoo.el --- gentoo specific editing -*- lexical-binding: t; -*-
...
(add-to-list 'auto-mode-alist '("\\.log\\'" . bc-gentoo--apply-ansi-color))

(defun bc-gentoo--apply-ansi-color ()
